...
| **Jalapeño / cliente-âncora** | OpenAI take-or-pay ~$25B; Codex-Spark niche = fast LLM inference | OpenAI anuncia chip "Jalapeño" (parceria Broadcom) para inferência própria — ameaça direta ao niche de Cerebras; CBRS -19% abaixo do IPO price | **✗ contesta** (cliente-âncora desenvolve substituto) |
